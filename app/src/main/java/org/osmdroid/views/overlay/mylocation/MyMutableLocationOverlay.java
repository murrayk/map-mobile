 ...
 *
 */
public class MyMutableLocationOverlay extends Overlay implements IMyLocationConsumer,
    ...
    public MyMutableLocationOverlay(Context context, MapView mapView) {
        this(context, new GpsMyLocationProvider(context), mapView);
    }

    public MyMutableLocationOverlay(Context context, IMyLocationProvider myLocationProvider,
                                MapView mapView) {
        this(myLocationProvider, mapView, new DefaultResourceProxyImpl(context));
    }

    public MyMutableLocationOverlay(IMyLocationProvider myLocationProvider, MapView mapView,
